...
<body>
	...
	<a href="index.jsp"><img alt="Sair" title="Sair"
		src="resources/img/fechar.png" width="52px" height="52px"></a>
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" id="quantidade" name="quantidade"
							value="${produto.quantidade}" maxlength="9"></td>
					</tr>
					<tr>
						<td>Valor R$:</td>
		...
		<table class="table table-dark">
			...
			<c:forEach items="${produtos}" var="produto">
				<tr>
					...
					<td style="width: 150px"><fmt:formatNumber type="number" maxFractionDigits="3"
							value="${produto.valor}" /></td>

					<td style="width: 150px"><a href="salvarProduto?acao=delete&produto=${produto.id}"
					...
					<td style="width: 150px"><a href="salvarProduto?acao=editar&produto=${produto.id}"><img
